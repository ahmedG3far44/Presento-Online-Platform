...
import ContactsFrom from "@/app/components/ui/profile/forms/ContactsFrom";
...
function BioForm() {
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="w-3/4 m-auto flex justify-start items-start gap-8">
        <form className="w-1/2  flex flex-col justify-start items-start gap-2 p-4 rounded-md border">
          ...
          <input
            onChange={(e) =>
              setBioState({ ...bioState, imgUrl: e.target.value })
            }
            className="w-full p-2 rounded-md "
            type="url"
